          ...
          >
            <CarouselContent className="-ml-2 md:-ml-4">
              {transformations.map((transformation, index) => {
                const hasTransform = transformation.zoom !== 1 || transformation.positionX !== 0 || transformation.positionY !== 0;
                return (
                      ...
                      {hasTransform ? (
                        <div className="w-full overflow-hidden">
                          <img
                            ...
                            style={{
                              transform: `scale(${transformation.zoom}) translate(${transformation.positionX / transformation.zoom}px, ${transformation.positionY / transformation.zoom}px)`,
