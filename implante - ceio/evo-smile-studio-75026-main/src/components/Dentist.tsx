      ...
      <div className="container px-4 mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Especialistas em Implantodontia, com anos de experiência e formação de excelência.
          </p>
        </motion.div>
                ...
                >
                  <div className="bg-card rounded-3xl overflow-hidden shadow-soft hover:shadow-strong transition-all duration-300 border border-border/50 h-full flex flex-col">
                    ...
                    <div className="relative aspect-[4/3] overflow-hidden">
                      {(doctor.zoom !== 1 || doctor.positionX !== 0 || doctor.positionY !== 0) ? (
                        <img
                          src={doctor.src}
                          alt={doctor.alt}
                          className="w-full h-full object-cover"
                          style={{
                            transform: `scale(${doctor.zoom}) translate(${doctor.positionX / doctor.zoom}px, ${doctor.positionY / doctor.zoom}px)`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-strong">
                {(doctors[0].zoom !== 1 || doctors[0].positionX !== 0 || doctors[0].positionY !== 0) ? (
                  <img
                    src={doctors[0].src}
                    alt={doctors[0].alt}
                    className="w-full h-auto aspect-square object-cover"
                    style={{
                      transform: `scale(${doctors[0].zoom}) translate(${doctors[0].positionX / doctors[0].zoom}px, ${doctors[0].positionY / doctors[0].zoom}px)`,
                      transformOrigin: 'center center',
                    }}
                    loading="lazy"
                    decoding="async"
                  ...
                  <img
                    src={doctors[0].src}
                    alt={doctors[0].alt}
                    className="w-full h-auto aspect-square object-cover object-[center_bottom]"
                    loading="lazy"
                    decoding="async"
                  />
                )}
